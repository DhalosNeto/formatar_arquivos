...
1. **Leia o estado** em `docs/estado-do-backend.md` e a fase relevante em
   `docs/plano-backend.md`. API pública: `docs/contrato-api.md`.
   `docs/plano.md` é histórico, não roteiro vigente.
