...
1. **Leia o plano** em `/home/daniel-halos/.claude/plans/voce-um-sre-magical-tarjan.md` — ele define arquitetura, CDM, ruleset, fases e invariantes.
...
3. **Consulte o precedente.** `/home/daniel-halos/Documentos/Projetos/functions-system-ff` é a referência arquitetural (hexagonal, Echo atrás de `routes/contract.go`, `infra/errors`, `data/contracts`). Confira como um problema parecido foi resolvido lá antes de inventar.
